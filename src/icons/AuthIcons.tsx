...
export const CloseIcon = () => {
  return (
    <svg width="24" height="24" viewBox="0 0 24 24" strokeWidth="1.5" stroke="#ff2825" fill="none" strokeLinecap="round" strokeLinejoin="round">
...
export const CheckIcon = () => {
  return (
    <svg width="24" height="24" viewBox="0 0 24 24" strokeWidth="1.5" stroke="rgb(34 197 94)" fill="none" strokeLinecap="round" strokeLinejoin="round">
      <path stroke="none" d="M0 0h24v24H0z" fill="none"/>
